export const DocsIcon = () => {
  return (
    <div>
      ...
      >
        <radialGradient
          id="aMOb3qD7zkaYDIFnaYS0Za_118955_gr1"
          cx="32"
          cy="32"
          r="33.002"
        ...
        <path
          fill="url(#aMOb3qD7zkaYDIFnaYS0Zb_118955_gr2)"
          d="M50,58H16c-1.657,0-3-1.343-3-3V9c0-1.657,1.343-3,3-3h20.757 c0.796,0,1.559,0.316,2.121,0.879l13.243,13.243C52.684,20.684,53,21.447,53,22.243V55C53,56.657,51.657,58,50,58z"
        ></path>
        <linearGradient
          id="aMOb3qD7zkaYDIFnaYS0Zc_118955_gr3"
          x1="38.879"
          x2="46.454"
          y1="20.121"
          y2="12.546"
        ...
        >
          ...
          <stop offset=".375" stop-color="#b7ecfd"></stop>
          <stop offset="1" stop-color="#95e6fd"></stop>
        </linearGradient>
        <path
          fill="url(#aMOb3qD7zkaYDIFnaYS0Zc_118955_gr3)"
          d="M52.121,20.122L38.878,6.879c-0.255-0.255-0.556-0.452-0.878-0.6V18c0,1.657,1.343,3,3,3 h11.721C52.574,20.678,52.377,20.377,52.121,20.122z"
        ></path>
        <linearGradient
          id="aMOb3qD7zkaYDIFnaYS0Zd_118955_gr4"
          x1="45.5"
          x2="45.5"
          y1="24.083"
          y2="18.083"
