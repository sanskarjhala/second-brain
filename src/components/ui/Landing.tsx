...
export default function LandingSection() {
  ...
  return (
    <div className="min-h-screen  md:-mt-40 -mt-4 dark:bg-darkbg text-black">

      <section
        className="flex justify-center relative max-w- md:-mt-72 lg:-mt-4 
  mx-auto"
      >
        <div
   ...
   sm:px-10 md:px-16 lg:px-0"
        >
          ...
          <motion.div
            ...
            className="lg:pl-8"
          >
            <h2 className="text-2xl md:text-3xl font-bold border-l-4 border-purple-500 pl-4 dark:text-white k">
              How It Works
            </h2>
      ...
      <div className="grid gap-6 md:grid-cols-4 sm:grid-cols-2 max-w-6xl mx-auto px-2 mb-16">
        {features.map((f, i) => (
          <div
            key={i}
            className="bg-white rounded-2xl dark:bg-black 
